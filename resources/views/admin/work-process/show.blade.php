        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    @if(is_file('uploads/'.$path.'/'.$row->icon))
                    <hr/>
                    <p><span class="text-highlight">{{ __('dashboard.icon') }}:</span></p>
                    <img src="{{ asset('uploads/'.$path.'/'.$row->icon) }}" class="img-fluid icon-thumb" alt="Icon">
                    @endif
                    <hr/>
