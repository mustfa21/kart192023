              ...
              <form class="needs-validation" novalidate action="{{ route($route.'.update', $row->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="description" id="meta_description" rows="4">{!! $row->description !!}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="keywords" id="meta_keywords" rows="4">{!! $row->keywords !!}</textarea>
