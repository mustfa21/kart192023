        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p><span class="text-highlight">{{ __('dashboard.meta_description') }}:</span> {!! $row->description !!}</p>
                    <p><span class="text-highlight">{{ __('dashboard.meta_keywords') }}:</span> {!! $row->keywords !!}</p>
